...
import edu.aha.agualimpiafinal.databinding.ActivityGirasolChallengeBinding;
...
public class GirasolChallengeActivity extends AppCompatActivity {

    private ActivityGirasolChallengeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGirasolChallengeBinding.inflate(getLayoutInflater());
    ...
    private void getUserInfoAll() {
        ...
        getUserInfo(email, "pistilo girasol", binding.circleImageViewPhoto, binding.textViewImagenNosubida, binding.btnregistrar);
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    if(task.getResult().size() > 0)
                    {
                        ...
                        //Set image from db
                        Glide.with(GirasolChallengeActivity.this)
                                .load(url)
    ...
    private void updatePhoto(final File mImageFileReciever, MaterialTextView textViewImagenNosubida, String idphoto) {
        ...
        mDialog = new ProgressDialog(GirasolChallengeActivity.this);
        ...
        if(idphoto != null)
        {
            ...
            if(mImageFileReciever != null)
            {
                if(!mImageFileReciever.equals(""))
                {
                    ...
                    mImageProvider.save(GirasolChallengeActivity.this, mImageFileReciever).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            ...
                            if(task.isSuccessful())
                            {
                                ...
                                mDialog.dismiss();
                                Toast.makeText(GirasolChallengeActivity.this, "No se pudo almacenar la imagen", Toast.LENGTH_SHORT).show();
                            }
    ...
    private void updatePhotoFirebase(String url, MaterialTextView textView, String idphoto) {
        ...
        mInsectosProvider.update(idphoto, url).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    textView.setVisibility(View.GONE);
                    Toast.makeText(GirasolChallengeActivity.this, "Foto actualizado Correctamente", Toast.LENGTH_SHORT).show();
                    mDialog.dismiss();
    ...
    private void SaveOnFirebase(String url, MoldeSustantivo sus, TextView textView) {
        ...
        mInsectosProvider.create(sus).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    textView.setVisibility(View.GONE);
                    Toast.makeText(GirasolChallengeActivity.this, "Datos registrados correctamente", Toast.LENGTH_SHORT).show();
                    mDialog.dismiss();
    ...
    private void goToNextActivity(int points, int descripcion, String imageurl, String title) {
        ...
        Intent i = new Intent(GirasolChallengeActivity.this, ResultadoCapturaImageActivity.class);
    ...
    private void openCamera(int requescode) {
        ...
        Pix.start(GirasolChallengeActivity.this, mOptions);
        ...
        switch (requestCode) {
            case PermUtil.REQUEST_CODE_ASK_MULTIPLE_PERMISSIONS: {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(GirasolChallengeActivity.this, "Approve permissions to open Pix ImagePicker", Toast.LENGTH_LONG).show();
                }
                return;
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        {
            Toast.makeText(GirasolChallengeActivity.this, "operacion Cancelado!", Toast.LENGTH_SHORT).show();
        }

...
import edu.aha.agualimpiafinal.databinding.ActivityPlantsChallengerBinding;
import edu.aha.agualimpiafinal.databinding.CustomDialogMoreinfoBinding;

public class PlantsChallengerActivity extends AppCompatActivity {

    private ActivityPlantsChallengerBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityPlantsChallengerBinding.inflate(getLayoutInflater());
    ...
    private void openDialogs() {
        ...
        binding.cardview1.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PlantsChallengerActivity.this, GirasolChallengeActivity.class);
        ...
        binding.cardview2.card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PlantsChallengerActivity.this, AnacroneuriaActivity.class);
        ...
        binding.cardview3.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PlantsChallengerActivity.this, AnacroneuriaActivity.class);
                createDialog(R.drawable.flower_lirio,R.string.text_flower_lirio,intent,"Lirio");
            }
        });
    }
    ...
    private void setDataChallenges() {
        ...
        binding.cardview3.roundedImageView.setImageDrawable(getDrawable(R.drawable.flower_lirio));
    ...
    private void createDialog(int drawable, int textChallenge, Intent intentReceiver, String title)
    {
        ...
        customBinding.btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(PlantsChallengerActivity.this, "Bien hecho", Toast.LENGTH_SHORT).show();
